...
#define RF_MID_BAND_THRESHOLD           868E6
...
void LoRa_end(void);
bool LoRa_beginPacket(bool implicitHeader); // implicitHeader = 0
bool LoRa_endPacket(bool async); // async = 0
...
void LoRa_setTxPower(int level, bool outputPin); // outputPin = PA_OUTPUT_PA_BOOST_PIN
